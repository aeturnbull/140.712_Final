...
2. Which textual features best predict whether the physician colleagues think prognosis for survival was disclosed? Are there correlations between either MD characteristics or actor rating and predicted probability the colleagues think the physician disclosed prognosis?
...
## Step 1: computing the distance between each transcript using two different distances
    ...
    ## Looking for NAs that can screw up these next functions
    matrix_measures %>%
            summarise_all(funs(sum(is.na(.))))
    
    ## This is an easy fix - this was coded NA if colleagues didn't think they disclosed prognosis at all, let alone explicitly. 
...
Nope, nothing related to trial arm but 3 clear clusters with an outlier.
